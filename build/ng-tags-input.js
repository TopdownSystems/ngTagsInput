 ...
 * License: MIT
 *
 * Generated at 2017-09-04 13:43:29 +0200
 */
(function (angular$1) {
'use strict';
...
function TagsInputDirective($timeout, $document, $window, $q, tagsInputConfig, tiUtil, tiConstants) {
  ...
  return {
    ...
    link: function link(scope, element, attrs, ngModelCtrl) {
      var hotkeys = [tiConstants.KEYS.enter, tiConstants.KEYS.tab, tiConstants.KEYS.comma, tiConstants.KEYS.space, tiConstants.KEYS.backspace, tiConstants.KEYS.delete, tiConstants.KEYS.left, tiConstants.KEYS.right];
